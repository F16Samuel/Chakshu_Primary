...
import { Loader2, CameraIcon, AlertCircle, Video } from "lucide-react"; // Removed Play, Square, Monitor as they are for streaming control
import { cn } from "@/lib/utils"; // Assuming you still use cn for class utility
