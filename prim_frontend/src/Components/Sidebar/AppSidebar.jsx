...
const navigationItems = [
  ...
  { title: "Face ID", url: import.meta.env.VITE_APP_FACE_ID_URL, icon: User, description: "Facial recognition system" },
  { title: "Weapon Detect", url: import.meta.env.VITE_APP_WEAPON_DETECT_URL, icon: Shield, description: "Weapon identification" },
  { title: "Riot Monitor", url: import.meta.env.VITE_APP_RIOT_MONITOR_URL, icon: Users, description: "Riot detection system" },
  { title: "Area Guard", url: import.meta.env.VITE_APP_AREA_GUARD_URL, icon: MapPin, description: "Restricted area monitoring" },
];
